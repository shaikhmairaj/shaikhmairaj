...
## About Me
I'm a passionate **Data Engineer** | **Data Analyst** | **BI Developer** with a proven record of building robust, scalable, and real-time data pipelines,dashboards,reports and analytics platforms. With experience across multiple domains like **financial data**, **medical data**, and **Ecommerce Sales Analysis**, I thrive in data-intensive environments and love turning raw data into actionable insights.

- 📊 1+ years of experience in **data engineering**, working with high-volume datasets and real-time data systems.
- ☁️ Skilled in **AWS, Snowflake, Kafka, Airflow, Glue,Athena,EC2,Tableau,Power BI**, and other cloud-native tools.
...
**Frameworks/Platforms**: Apache Airflow, Kafka, AWS Glue, Lambda, S3, Redshift,Snowflake  
**Tools & Libraries**: Pandas, PySpark, Selenium, Git, Power BI, Tableau,AWS SageMaker  
...
In this project, I have fetched hourly stock data in Real time, process it in Python, and orchestrate the entire workflow using Airflow DAGs.
...
Objective of this project, the owner of the Super Store wants us to help them to create a dashboard to track and analyze their online sales across Pakistan and generate reports.
